"""Grouped kernel parameter stacking and exact kernel runners."""
...
from .types import FlatTopology, KernelBatchPlan, KernelMatch, RelationSlice


class FlatRelationRunnerMixin:
    ...
    def _collect_block_batch_items(
        self,
        *,
        ...
        for relation_index in relation_indices:
            ...
            if match is None or not isinstance(match.kernel, expected_kernel_types):
                return None
    ...
    def _stack_optional_tensors(
        ...
        *,
        ...
        return self._get_grouped_param_stack(
            cache_key=cache_key,
            tensors=present,
    ...
    def _stack_block_two_layer_params(
        ...
        *,
        ...
        b1_stack = self._stack_optional_tensors(
        ...
        b2_stack = self._stack_optional_tensors(
    ...
    def _stack_program_stage_params(
        ...
        *,
        ...
        if any(match.linears[0].bias is None or match.linears[1].bias is None for match in stage_matches):
            return None
        w1_stack = self._get_grouped_param_stack(
    ...
    def _run_two_layer_pointwise_kernel(
        ...
        *,
        ...
        batch_items = self._collect_block_batch_items(
            ...
            expected_kernel_types=expected_kernel_types,
        )
        if not batch_items:
            return None
    ...
    def _run_postnorm_layernorm_kernel(
        ...
        *,
        ...
        if affine:
            ln_weight_stack = self._stack_optional_tensors(
            ...
            ln_bias_stack = self._stack_optional_tensors(
    ...
    def _run_prenorm_rmsnorm_kernel(
        ...
        *,
        ...
        batch_items = self._collect_block_batch_items(
            topology=topology,
            grouped_batch=grouped_batch,
            expected_kernel_types=(PreNormSiLURMSNormKernel,),
        )
        if not batch_items:
            return None
        ...
        if affine:
            rms_weight_stack = self._stack_optional_tensors(
    ...
    def _run_silu_pair_program_kernel(
        ...
        *,
        ...
        stage0_params = self._stack_program_stage_params(
        ...
        stage1_params = self._stack_program_stage_params(
...
__all__ = ["FlatRelationRunnerMixin"]
